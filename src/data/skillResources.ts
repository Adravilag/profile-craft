...
export interface SkillResource {
  ...
  url: string;
  description: string;
  category: 'documentation' | 'tutorial' | 'course' | 'cheatsheet' | 'tool' | 'book' | 'video' | 'github' | 'article';
  ...
  "CSS3": [
    {
      ...
      description: "Documentación oficial de CSS con ejemplos prácticos y compatibilidad de navegadores",
...
export const filterResourcesByLevel = (resources: SkillResource[], level: string): SkillResource[] => {
...
// Mapeo de categorías a iconos y labels en español
export const categoryConfig = {
  documentation: { icon: 'fa-book', label: 'Documentación', color: '#3b82f6' },
  tutorial: { icon: 'fa-play-circle', label: 'Tutoriales', color: '#10b981' },
  course: { icon: 'fa-graduation-cap', label: 'Cursos', color: '#8b5cf6' },
  cheatsheet: { icon: 'fa-list-alt', label: 'Cheat Sheets', color: '#f59e0b' },
  tool: { icon: 'fa-tools', label: 'Herramientas', color: '#ef4444' },
  book: { icon: 'fa-book-open', label: 'Libros', color: '#6366f1' },
  video: { icon: 'fa-video', label: 'Videos', color: '#ec4899' },
  github: { icon: 'fa-code-branch', label: 'Repositorios', color: '#374151' },
  article: { icon: 'fa-newspaper', label: 'Artículos', color: '#059669' }
};
