...
interface NotificationContextType {
  ...
  showNotification: (type: Notification['type'], title: string, message?: string, duration?: number, options?: NotificationOptions) => string;
...
export const NotificationProvider: React.FC<NotificationProviderProps> = ({ 
  ...
  const manageNotificationQueue = useCallback((newNotifications: ExtendedNotification[]) => {
