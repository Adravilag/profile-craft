...
import ModalPortal from '../common/portals/ModalPortal';
import styles from './MediaLibrary.module.css';
import { uploadImage, getMediaFiles, deleteMediaFile, type MediaItem as APIMediaItem } from '@cv-maker/shared';
