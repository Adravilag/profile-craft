...
import { CERTIFICATION_ISSUERS, ISSUER_CATEGORIES, type CertificationIssuer } from '@cv-maker/shared';
...
const IssuerSelector: React.FC<IssuerSelectorProps> = ({
  ...
  const filteredIssuers = CERTIFICATION_ISSUERS.filter((issuer: CertificationIssuer) => {
        ...
        <div className={styles.dropdownContainer}>
          ...
          <div className={styles.categoryFilters}>
            ...
            <div className={styles.categoryButtons}>
              {ISSUER_CATEGORIES.map((category: any) => (
                <button
                  key={category.id}
                  type="button"
          ...
          <div className={styles.issuersList}>
            {filteredIssuers.length === 0 ? (
              ...
              filteredIssuers.map((issuer: CertificationIssuer) => (
                <button
                  key={issuer.id}
                  type="button"
                ...
                >
                  ...
                  <div className={styles.issuerInfo}>
                    ...
                    <div className={styles.issuerCategory}>
                      ...
                      {ISSUER_CATEGORIES.find((cat: any) => cat.id === issuer.category)?.name}
                    </div>
                  </div>
