...
export const useSmartScroll = (config: SmartScrollConfig) => {
   ...
   */
  const smoothScrollTo = useCallback((targetY: number, animationDuration: number = duration) => {
   ...
   */
  const calculateScrollPosition = useCallback((sectionId: string): ScrollPosition => {
   ...
   */
  const scrollToSection = useCallback((sectionId: string, animationDuration?: number) => {
   ...
   */
  const scrollToNavSticky = useCallback((animationDuration?: number) => {
   ...
   */
  const scrollToTop = useCallback((animationDuration?: number) => {
