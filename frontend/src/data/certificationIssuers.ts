...
export const CERTIFICATION_ISSUERS: CertificationIssuer[] = [  // Cloud Providers
  {
    id: 'aws',
  ...
  // Security
  {
    ...
    verifyBaseUrl: 'https://www.cisco.com/c/en/us/training-events/training-certifications/certifications/verify.html',
    category: 'security',
...
export const findIssuerByName = (name: string): CertificationIssuer | undefined => {
  ...
  return CERTIFICATION_ISSUERS.find(issuer => 
...
export const generateVerifyUrl = (issuer: CertificationIssuer, credentialId: string): string | undefined => {
